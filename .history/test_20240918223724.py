...
st.title("pregnancy risk Prediction Using Machine Learning")
...
with tabs[0]:
    ...
    SystolicBP = st.selectbox("SystolicBP")
    DiastolicBP = st.selectbox("DiastolicBP")
    BS = st.selectbox("BS")
    BodyTemp = st.selectbox("BodyTemp")
    HeartRate = st.selectbox("HeartRate")
